...
private:
  ...
  public:
    ...
    bool load_backup();
    std::vector<community*> big_list_make(std::vector<community*> first_list, std::vector<community*> second_list);
    ...
    void bincross(const individual& parent1, const individual& parent2,
                   individual& child1, individual& child2);
    void commcross(const individual& parent1, const individual& parent2,
                   individual& child1, individual& child2);
