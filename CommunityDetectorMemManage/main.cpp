...
void test_problem1(std::vector<double>* obj, std::vector<nsga2::community*>* comm) {
  ...
  //cout << "ObjFunc1: " << (*obj)[0] << "ObjFunc2: " << (*obj)[1] << endl;
...
int main(void) 
{
	...
	cin >> nvertices;
	cout << "THIS IS THE NUMBER OF VERTICES: " << nvertices << endl; // DEBUG: CHECK INPUT FILE
